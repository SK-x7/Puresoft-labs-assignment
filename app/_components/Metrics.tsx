...
function Metrics({ metrics }: { metrics: metricsProps }) {
  return (
    <div className="w-full grid grid-cols-2 min-[420px]:grid-cols-3  sm:grid-cols-3 row-auto gap-4 h-full">
      ...
      <div className="p-4 flex flex-col bg-white rounded-xl gap-3 h-full">
        <span className="text-xs md:!text-base">Question Answered</span>
        <span className="text-lg md:text-xl  lg:text-2xl  font-bold">
          {metrics.questions_answered}
        </span>
      </div>
      <div className="p-4 flex flex-col bg-white rounded-xl gap-3 h-full">
        <span className="text-xs md:!text-base font-medium">Av. session length</span>
        <span className="text-lg md:text-xl lg:text-2xl  font-bold">
      ...
      <div className="p-4 flex flex-col bg-white rounded-xl justify-start gap-1 sm:justify-evenly h-full">
        <span className="text-xs md:!text-base">Starting knowledge</span>
        <span className="text-lg md:text-xl lg:text-2xl  font-bold">
      ...
      <div className="p-4 flex flex-col bg-white rounded-xl justify-start gap-1 sm:justify-evenly h-full">
        <span className="text-xs md:!text-base">Current knowledge</span>
        <span className="text-lg md:text-xl lg:text-2xl  font-bold">
      ...
      <div className="p-4 flex flex-col bg-white rounded-xl justify-start gap-1  sm:justify-evenly h-full">
        <span className="capitalize text-xs md:!text-base">knowledge gain</span>
        <span className="text-lg md:text-xl lg:text-2xl  font-bold">
          {Math.round(
            ((metrics.current_knowledge_percentage -
              metrics.starting_knowledge_percentage) /
